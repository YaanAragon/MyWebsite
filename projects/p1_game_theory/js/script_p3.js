(function () {
  ...
  document.body.insertAdjacentHTML('beforeend', '<p>Part 3 Win-Stay, Lose-Shift: ALL_C, ALL_D, TFT, WSLS </p>');
  ...
  var number_of_game_repeats = Number(__cfg.number_of_game_repeats ?? 100);
  var error_rate = Number(__cfg.error_rate ?? 0.002);
